...
<head>
    ...
    <!-- Site Metas -->
    <title>Treatments | BCG Coach </title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link active" href="#">Treatment</a></li>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="row align-items-center about-main-info">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <p>You may be advised to drink plenty of fluid to flush the rest of the medication from your bladder.
...
Women should avoid getting pregnant or breastfeeding while on BCG therapy.
                                    ...
                                    Treatment is usually given every week for six weeks. After that, you might need to do it once a month for six months to a year.</p>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="about-m">
                                    <ul id="banner">
                                        ...
                                        <li>
                                            <img src="images/about-img-222.jpg" alt="">
                                        </li>
                                    </ul>
                                </div>
                            </div>
