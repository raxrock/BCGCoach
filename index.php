            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link" href="#about">About BCG</a></li>
                        <li><a class="nav-link" href="sideeffects.php">Side Effects </a></li>
                        <li><a class="nav-link" href="treatment.php">Treatment</a></li>
                        <li><a class="nav-link" href="timeline.php">Timeline</a></li>
                        <li><a class="nav-link" href="#team">FAQ</a></li>
                    ...
                    <div class="pogoSlider-slide" data-transition="fade" data-duration="1500" style="background-image:url(images/slider-03.jpg);">
                        <div class="lbox-caption pogoSlider-slide-element">
                            <div class="lbox-details">
                                ...
                                <a href="sideeffects.php" class="btn">Know more</a>
                            </div>
                        </div>
                     ...
                     <div class="pogoSlider-slide" data-transition="fade" data-duration="1500" style="background-image:url(images/slider-02.jpg);">
                        <div class="lbox-caption pogoSlider-slide-element">
                            <div class="lbox-details">
                                ...
                                <a href="treatment.php" class="btn">Know More</a>
                            </div>
                        </div>
                    </div>
                </div><!-- .pogoSlider -->
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="row align-items-center about-main-info">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <h2> What is BCG ? (Bacillus Calmette-Guerin) </h2>
                                <p>BCG is a weakened form of the bacteria that causes
                                    tuberculosis (TB). It is the standard of care to treat
                                    bladder cancer. </p>
                                <p>BCG can be given after the tumor growth in your bladder
                                    has been completely removed.
                                </p>
                                <p>BCG triggers your immune system to attack the cancer
                                    cells in your bladder. BCG may stop the future growth of
                                    cancer cells</p>
                ...
                <div class="col-md-12 col-md-12 col-md-12" align="center">
                    <div class="about-main-info" align="center">
                        <div class="col-lg-6 col-md-6 col-sm-12" align="center">
                            ...
                            <a href="sideeffects.php" class="new-btn-d br-2">Side Effects</a>
                            <a href="treatment.php" class="new-btn-d br-2">Treatment</a>
                            <a href="timeline.php" class="new-btn-d br-2">Timeline</a>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" class="form-control"pattern="[a-zA-Z\s]+" title="Only Charecters are allowed / Enter Your Full name" name="name" placeholder="Your Name" required data-error="Please enter your name">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="email"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" placeholder="Your Email" class="form-control" name="email" required data-error="Please enter your email">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="tel" minlength="10" maxlength="10" pattern="[6-9]{1}[0-9]{9}" title="Phone number with 6-9 and remaing 9 digit with 0-9" placeholder="Your number" class="form-control" name="number" required data-error="Please enter your number">
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-12">
