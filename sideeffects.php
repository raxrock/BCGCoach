...
<head>
    ...
    <!-- Site Metas -->
    <title>Side Effects | BCG Coach </title>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbar-wd">
                    <ul class="navbar-nav">
                        ...
                        <li><a class="nav-link active" href="#sideeffects">Side Effects </a></li>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="row align-items-center about-main-info">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <h2> What side effects can occur? </h2>
                                <p>One benefit of BCG is that while it affects the cells in your bladder, it doesn’t have a major effect on any other part of your body. But there can be a few side effects such as:
...
Serious complications of this infection include inflammation of the lungs, hepatitis, and inflammation of the prostate and testicles. If you have any sign of serious infection, seek immediate medical attention.</p>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="about-m">
                                    <ul id="banner">
                                        ...
                                        <li>
                                            <img src="images/about-img-111.jpg" alt="">
                                        </li>
                                    </ul>
                                </div>
                            </div>
