                                        ...
                                        <div class="panel panel-white">
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form role="form" name="book" method="post">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="q2">
                                                            When was the last dose of BCG recived ?
                                                        </label><br>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="q5">
                                                            Are you having pain on passing urine?
                                                        </label><br>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="q6">
                                                            How many times do you wake up to pass urine after sleeping ?
                                                        ...
                                                        <input type="radio" name="q6" value="more than 3" required="true"> More than 3 times.
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="radio" name="q7" value="10-15" required="true"> 10 to 15 times
                                                        <input type="radio" name="q7" value=">15" checked required="true"> More than 15 times
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="q8">
                                                            How urgently do you have to rust to pass to urine ?
                                                        </label><br>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="radio" name="q9" value="mild" checked required="true"> MILD
                                                        <input type="radio" name="q9" value="moderate" required="true"> MODERATE
                                                        <input type="radio" name="q9" value="severe" required="true"> SEVERE
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="q12">
                                                            Did you visit any doctor for these symptoms ?
                                                        </label><br>
                                                    ...
                                                    <div class="form-group">
                                                        <label for="q13">
                                                            Were you admitted for these symptoms ?
                                                        </label><br>
